<%-- 
    ...
    Created on : 17 nov. 2025, 04:20:55
    Author     : cresp
--%>
...
<html lang="es">
    ...
    <body class="bg-light">
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="menuAdmin">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mb-1"><a class="nav-link active text-white" href="<%=ctx%>/reservasUsuario?op=list">📅 Reservas</a></li>
        ...
        <div class="container my-4">
            ...
            <form class="row g-2 mb-3" action="<%=ctx%>/reservasUsuario" method="get">
                <input type="hidden" name="op" value="list">
                <div class="col-md-4">
                    <select class="form-select" name="estado">
                        <option value="">Todos los estados</option>
                        <option <%= "pendiente".equals(request.getParameter("estado")) ? "selected" : ""%> >pendiente</option>
                        <option <%= "confirmada".equals(request.getParameter("estado")) ? "selected" : ""%> >confirmada</option>
                        <option <%= "cancelada".equals(request.getParameter("estado")) ? "selected" : ""%> >cancelada</option>
                        <option <%= "completada".equals(request.getParameter("estado")) ? "selected" : ""%> >completada</option>
                    </select>
                </div>
                    ...
                    <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <!-- Cambiar estado -->
                                    <form action="<%=ctx%>/reservasUsuario" method="post" class="d-inline">
                                    ...
                                    <form action="<%=ctx%>/reservasUsuario" method="post" class="d-inline" onsubmit="return confirm('¿Eliminar reserva?');">
        ...
        <div class="modal fade" id="mdlNueva" tabindex="-1">
            <div class="modal-dialog modal-lg"><div class="modal-content">
                    <form class="row g-3" action="<%=ctx%>/reservasUsuario" method="post">
