...
<%
    ...
    // Verificar si la respuesta ya fue commiteada
    ...
    if (!"ADMIN".equals(role)) {
        response.sendRedirect(ctx + "/usuarios.jsp");
        return;
    }
    ...
    if (huespedesFrecuentes == null) {
        huespedesFrecuentes = 0;
    }
    if (variacionIngresos == null) {
        variacionIngresos = 0.0;
    }
    if (variacionOcupacion == null)
        variacionOcupacion = 0.0;
%>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <title>Administrador - Hostal</title>
    ...
    <body class="bg-light">
        ...
        <nav class="navbar navbar-dark bg-dark px-3 sticky-top">
            <div class="container-fluid">
                ...
                <span class="navbar-text mx-auto text-white fw-semibold">
                    <span class="brand-dot"></span> Panel de Administración
                </span>

                <!-- Usuario + Salir -->
                <div class="d-flex align-items-center gap-2">
                    <span class="text-white-50 small d-none d-sm-inline"><%= (username != null ? username : "Administrador")%></span>
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="menuLateralAdmin" aria-labelledby="menuLateralAdminLabel">
            <div class="offcanvas-header">
                <div>
                    <h5 class="offcanvas-title" id="menuLateralAdminLabel">Menú Admin</h5>
            ...
            <div class="row g-3">
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <h4 class="card-title mb-3">Bienvenido, <%= (username != null ? username : "Administrador")%> 👋</h4>
                            <p class="text-muted mb-0">Usa el menú de la izquierda para gestionar habitaciones, huéspedes, reservas, pagos, empleados, usuarios/roles, proveedores, reportes y gráficos.</p>
                        </div>
                    </div>
                </div>
