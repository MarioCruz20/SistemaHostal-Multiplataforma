<%-- 
    ...
    Created on : 11 nov. 2025, 16:51:48
    Author     : cresp
--%>
...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Habitaciones - Administrador</title>
    ...
    <body class="bg-light">
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="menuLateral" aria-labelledby="menuLateralLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mb-1"><a class="nav-link active text-white" href="<%=ctx%>/habitaciones?op=list">🛏️ Habitaciones</a></li>
        ...
        <div class="container my-4">
            ...
            <!-- Filtros -->
            <form class="row g-2 mb-3" action="<%=ctx%>/habitaciones" method="get">
                ...
                <div class="col-md-4">
                    <select name="tipo" class="form-select">
                        ...
                        <option value="individual" <%= "individual".equals(request.getParameter("tipo")) ? "selected" : ""%>>individual</option>
                        <option value="doble" <%= "doble".equals(request.getParameter("tipo")) ? "selected" : ""%>>doble</option>
                        <option value="familiar" <%= "familiar".equals(request.getParameter("tipo")) ? "selected" : ""%>>familiar</option>
                        <option value="suite" <%= "suite".equals(request.getParameter("tipo")) ? "selected" : ""%>>suite</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <select name="estado" class="form-select">
                        ...
                        <option value="reservada" <%= "reservada".equals(request.getParameter("estado")) ? "selected" : ""%>>reservada</option>
                        <option value="limpieza" <%= "limpieza".equals(request.getParameter("estado")) ? "selected" : ""%>>limpieza</option>
                        <option value="mantenimiento" <%= "mantenimiento".equals(request.getParameter("estado")) ? "selected" : ""%>>mantenimiento</option>
                    </select>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="btn-group btn-group-sm" role="group">
                                        <form action="<%=ctx%>/habitaciones" method="post" class="d-inline">
                                    ...
                                    <form action="<%=ctx%>/habitaciones" method="post" class="d-inline mt-1" onsubmit="return confirm('¿Eliminar habitación?');">
        ...
        <div class="modal fade" id="modalNueva" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <form class="row g-3" action="<%=ctx%>/habitaciones" method="post">
