<%-- 
    Document   : pagosUsuario
    Created on : 17 nov. 2025, 03:01:07
    Author     : cresp
--%>
...
<html lang="es">
    ...
    <body class="bg-light">
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="menuAdmin">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mb-3"><a class="nav-link active text-white" href="<%=ctx%>/pagosUsuario">💳 Pagos</a></li>
        ...
        <div class="container my-4">
            ...
            <!-- Filtro por Reserva -->
            <form class="row g-2 mb-3" action="<%=ctx%>/pagosUsuario" method="get">
                <div class="col-md-9">
                    ...
                    <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <form action="<%=ctx%>/pagosUsuario" method="post" class="d-inline" onsubmit="return confirm('¿Eliminar pago?');">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="formPago" class="row g-3" 
                          action="<%=ctx%>/pagosUsuario" 
                          method="post" 
                          onsubmit="return validarYProcesarPago(event)">
