<%-- 
    Document   : huespedesUsuario
    Created on : 17 nov. 2025, 02:57:50
    Author     : cresp
--%>
    ...
    <body class="bg-light">
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="menuAdmin">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title">Menú Usuario</h5>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mb-1"><a class="nav-link active text-white" href="<%=ctx%>/huespedesUsuario?op=list">👥 Huéspedes</a></li>
        ...
        <main class="content container-fluid">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <form class="row g-2 mb-3" action="<%=ctx%>/huespedesUsuario" method="get">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <!-- eliminar -->
                                                <form action="<%=ctx%>/huespedesUsuario" method="post" class="d-inline"
        ...
        <div class="modal fade" id="mdlNuevo" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form class="row g-3" action="<%=ctx%>/huespedesUsuario" method="post">
