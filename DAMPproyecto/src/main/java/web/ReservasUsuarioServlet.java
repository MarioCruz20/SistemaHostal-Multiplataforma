...
@WebServlet(name = "ReservasUsuarioServlet", urlPatterns = {"/reservasUsuario"})
public class ReservasUsuarioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (op == null || op.equals("list")) {
            ...
            req.getRequestDispatcher("reservasUsuario.jsp").forward(req, resp);
            return;
        }
        ...
        resp.sendRedirect(req.getContextPath() + "/reservasUsuario?op=list");
    }
