...
@WebServlet(name = "HuespedUsuarioServlet", urlPatterns = {"/huespedesUsuario"})
public class HuespedUsuarioServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (op == null || op.equals("list")) {
            ...
            req.getRequestDispatcher("huespedesUsuario.jsp").forward(req, resp);
            return;
        }
        ...
        resp.sendRedirect(req.getContextPath() + "/huespedesUsuario?op=list");
    }
